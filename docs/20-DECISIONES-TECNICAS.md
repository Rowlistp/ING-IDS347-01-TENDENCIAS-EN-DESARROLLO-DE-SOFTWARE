...
| Auditoría | Escritura transaccional y append-only PostgreSQL | Migración y pruebas PostgreSQL |
...
| API catálogos | Convención final español/inglés | Coordinar Builder 1 y consumidores |
