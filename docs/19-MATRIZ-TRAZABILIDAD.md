...
|---|---|---|---|---|---|---|---|
| RF-01 | Gestión de usuarios | 1 | Builder 2 | CU-02 | `/api/v1/users`, `/roles`, auth | Suite Fase 1 + PostgreSQL | **Implementado/Validado** |
...
| RF-05 | Solicitudes de combustible | 3 | Builder 1 backend + Builder 3 web | CU-06, CU-07 | Solicitudes | Pendiente | Pendiente por fase |
...
| RF-14 | Control de inventario | 6 | Builder 1 | CU-14 a CU-16 | Inventario | Pendiente | Pendiente por fase |
| RF-15 | Inventario en tiempo real | 6 | Builder 1 | CU-16 | Inventario/consultas | Pendiente | Pendiente por fase |
| RF-16 | Recepción de combustible | 6 | Builder 1 | CU-14 | Recepciones | Pendiente | Pendiente por fase |
| RF-17 | Movimientos de inventario | 6 | Builder 1 | CU-14, CU-15 | Movimientos | Pendiente | Pendiente por fase |
...
- Las rutas de catálogos actualmente implementadas están en español; la decisión
  de normalizarlas con el contrato inicial en inglés sigue pendiente.
